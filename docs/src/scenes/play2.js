...
export class Play2 extends Phaser.Scene {
  ...
  create() {
    ...
    mapavisible.setCollisionByProperty({c: true})
    ...
    this.physics.add.collider(player, mapavisible)
    ...
    //  The score
    scoreText = this.add.text(240, 575, "score: 0", {
      fontSize: "30px",
      fill: "#FFF",
    ...
    this.physics.add.collider(stars, mapavisible)
    this.physics.add.collider(stars2, mapavisible)
    this.physics.add.collider(bombs, mapavisible)
